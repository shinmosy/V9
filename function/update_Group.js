...
const fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: 'status@broadcast' } : {})}, message: { "contactMessage":{"displayName": `${metdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:conn\nitem1.TEL;waid=62895340684706:62895340684706\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
